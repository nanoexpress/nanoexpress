...
Very strange, when using this module, performance is slower by ~50% than uWebSockets.js while i'm expected maximum 10-20% performance loss. I'll already looking to fix this!
